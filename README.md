...
- 🚀 Skilled in React.js, TypeScript, TailwindCSS, and Node.js.
- 🎨 Focused on creating seamless UI/UX experiences.
- 🛠️ Proficient in state management (Redux, Context API).
- 🤝 Collaborative with Git, Agile, and CI/CD workflows.
